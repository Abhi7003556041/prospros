...
class _PostCardState extends State<PostCard> {
  ...
  void initState() {
    ...
    super.initState();
    print("isReportPossible ==========");
    print(widget.isReportPossible);
  }
