            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              widget.isDetailed
                  ...
                  : GestureDetector(
                      ...
                      child: Row(children: [
                        // On release use CachedNetworkImage 404 on errror image from backend
                        // CircleAvatar(
                        ...
                        //         ? const Text("AD",
                        //             style:
                        //                 TextStyle(fontSize: 14, color: Color(0xFFF4F5FC)))
                        //         : null),
                        ...
                        //             ? const Text("AD",
                        //                 style: TextStyle(
                        //                     fontSize: 14, color: Color(0xFFF4F5FC)))
                        //             : null),
                ...
                child: Material(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // quil.QuillEditor(
                      //     customStyleBuilder: (attributes) {
                      //       return TextStyle(fontFamily: AppTitle.fontNormal);
                      //     },
                      //     customStyles: quil.DefaultStyles(
                      //       h1: quil.DefaultTextBlockStyle(
                      //           TextStyle(
                      //               color: Colors.black,
                      //               fontSize: 18,
                      //               fontFamily: AppTitle.fontNormal),
                      //           quil.VerticalSpacing(0, 0),
                      //           quil.VerticalSpacing(0, 0),
                      //           null),
                      //       h2: quil.DefaultTextBlockStyle(
                      //           TextStyle(
                      //               color: Colors.black,
                      //               fontSize: 16,
                      //               fontFamily: AppTitle.fontNormal),
