...
class Data {
  ...
  ///while 2fa enabled this will be flag to know 2fa status
  ///possible values - 'yes' or 'no'
  String? twoFactorAuth;

  PersonalDetails? personalDetails;

  Data({this.token, this.personalDetails, this.twoFactorAuth});

  Data.fromJson(Map<String, dynamic> json) {
    token = json['token'];

    twoFactorAuth = json['_2fa'];
    printRed("#2factor auth : ${twoFactorAuth}");
