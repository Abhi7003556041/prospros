class SubscriptionResponseModel {
  ...
  SubscriptionResponseModel({this.success, this.data, this.message});
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        subscriptionData!.add(new SubscriptionData.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.subscriptionData != null) {
      data['data'] = this.subscriptionData!.map((v) => v.toJson()).toList();
    }
...
class SubscriptionData {
  ...
  SubscriptionData.fromJson(Map<String, dynamic> json) {
    ...
    getSubscription = json['get_subscription'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['get_subscription'] = this.getSubscription;
    return data;
  }
}
